...
Drink.create([{
    name: "Manhattan",
    ingredients: "2 oz rye whiskey, .75 oz sweet red vermouth, 1-2 dashes Angostura bitters, Maraschino cherry",
...
{
    name: "Old Fashioned",
    ingredients: "2 oz bourbon, 3-4 dashes Angostura bitters, 1 sugar cube, A few drops of water, Orange peel",
...
{
    name: "Paloma",
    ingredients: "2 oz tequila, 6 oz grapefruit soda (such as Jarritos or Squirt), Lime wedge or grapefruit wedge",
...
{
    name: "Margarita",
    ingredients: "2 oz tequila, 1 oz Cointreau, 1 oz fresh lime juice, Lime wedge, Salt rim optional",
...
{
    name: "Tom Collins",
    ingredients: "1.5 oz Old Tom Gin, 2 oz club soda, 1 oz lemon juice, .5 oz simple syrup, Lemon slice, Maraschino cherry",
...
{
    name: "Gin & Tonic",
    ingredients: "2 oz gin, 2-6 oz tonic water (according to taste), Lime wedge",
    instructions: "In a glass filled with ice, pour gin and top with tonic. Stir and garnish with a lime wedge.",
    main_liquor: "Gin"
},
{
    name: "Daiquiri",
    ingredients: "1.5 oz white rum, 1 oz lime juice, .5 oz simple syrup, Lime wedge",
...
},
{
    ...
    ingredients: "2 oz dark rum, 4 oz ginger beer, .5 oz lime juice, Lime wedge",
...
{
    name: "White Russian",
    ingredients: "1.5 oz vodka, .75 oz coffee liqueur, 3 oz fresh cream",
...
{
    name: "Salty Dog",
    ingredients: "1.5 oz vodka, 3.5 oz grapefruit juice, Lime or grapefruit wedge, Sea salt",
...
{
    name: "Negroni",
    ingredients: " 1¼ ounces gin, 1¼ ounces Campari, 1¼ ounces sweet vermouth",
...
{
    name: "Whiskey Sour",
    ingredients: "2 ounces bourbon (or other whiskey), ¾ ounce fresh lemon juice, ¾ ounce simple syrup",
...
{
    name: "Vodka Gimlet",
    ingredients: "Four parts Vodka, One part sweetened Lime Juice",
...
{
    name: "Sangria",
    ingredients: "1 bottle red (or white) wine, 1 large orange, 1 cup thinly sliced seasonal fruit (ex. apples/pears/berries/peaches/etc.), 1 small lemon (sliced), ½ cup brandy, 1 to 2 tablespoons maple syrup (or other sweetener to taste)",
...
{
    name: "Froze",
    ingredients: "1 bottle rosé, ½ cup sugar, 8 ounces strawberries (quartered with stems removed), 2½ ounces fresh lemon juice",
...
{
    name: "Mulled Wine",
    ingredients: "4 cups apple cider, 1 bottle red wine, 1/4 cup honey, 2 cinnamon sticks, 1 orange (zested and juiced), 4 whole cloves, 3 star anise, 4 oranges (peeled for garnish)",
